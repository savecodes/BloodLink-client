        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/donors" className="hover:text-red-500">Search Donors</Link></li>
              <li><Link to="/requests" className="hover:text-red-500">Donation Requests</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><Link to="/guidelines" className="hover:text-red-500">Donor Guidelines</Link></li>
              <li><Link to="/blood-types" className="hover:text-red-500">Blood Types</Link></li>
